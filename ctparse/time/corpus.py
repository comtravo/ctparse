corpus = [
    ...
    (
        ...
        [
            ...
            "5.8. bis 16.8.",
            "5. bis zum 16.8.",
            "2018/08/05 - 2018/08/16",
            "2018/08/05 to 2018/08/16",
            "2018/08/05 - 2018/08/16",
            "2018/08/05 to 2018/08/16",
            "2018/08/05 - 2018/08/16",
            "2018/08/05 to 2018/08/16",
            "vom 05.08.2018 zum 16.08.2018",
            "from 2018/08/05 to 2018/08/16",
        ],
    ),
    (
        "Interval[]{2018-08-05 X:X (X/X) - 2018-08-16 X:X (X/X)}",
        ...
        [
            ...
            "vom 05.08 zum 16.08",
            "vom 05.08. zum 16.08.",
            "vom 05.08 zum 16.08.2018",
            "from 2018/08/05 to 2018/08/16",
            "from 2018-08-05 to 2018-08-16",
            "from 08/05 to 08/16",
            "von 05.08.2018 bis zum 16.08.2018",
            "from the 2018/08/05 to the 2018/08/16",
    ...
    (
        ...
        "2022-10-18T12:34",
        ["2022/11/01", "2022-11-01", "2022.11.01"],
    ),
    ("Time[]{2022-11-30 X:X (X/X)}", "2022-10-18T12:34", ["2022/11/30", "2022/30/11"]),
]
